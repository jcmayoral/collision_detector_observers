#ifndef _ROS_SERVICE_GetRecognizedSpeech_h
#define _ROS_SERVICE_GetRecognizedSpeech_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETRECOGNIZEDSPEECH[] = "mdr_speech_msgs/GetRecognizedSpeech";

  class GetRecognizedSpeechRequest : public ros::Msg
  {
    public:

    GetRecognizedSpeechRequest()
    {
    }
    ...
    const char * getType(){ return GETRECOGNIZEDSPEECH; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetRecognizedSpeechResponse : public ros::Msg
  {
    public:
  ...
  class GetRecognizedSpeech {
    public:
    typedef GetRecognizedSpeechRequest Request;
    typedef GetRecognizedSpeechResponse Response;
  };
