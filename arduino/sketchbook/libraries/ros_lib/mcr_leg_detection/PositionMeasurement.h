#ifndef _ROS_mcr_leg_detection_PositionMeasurement_h
#define _ROS_mcr_leg_detection_PositionMeasurement_h
...
namespace mcr_leg_detection
{
  ...
  class PositionMeasurement : public ros::Msg
  {
    ...
    const char * getType(){ return "mcr_leg_detection/PositionMeasurement"; };
