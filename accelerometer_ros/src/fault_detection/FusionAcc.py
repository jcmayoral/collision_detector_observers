...
class FusionAcc(ChangeDetection):
    ...
    def accCB(self, msg):
        ...
        new_measure = [msg.accel.linear.x,msg.accel.linear.y, msg.accel.angular.z]
        diff = (np.array(new_measure) - np.array(self.last_measure))
        self.last_measure = new_measure
